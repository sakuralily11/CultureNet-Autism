from utils import load_data, leave_1_out_ids, all_children_ids, target_only_ids, merge_data, process_summary
from models import *
...
if __name__ == '__main__':
    ...
    # Process Data - get average of ICC per model (for each culture)
